...
export function TechnicalReviewForm({
  ...
  item: TechnicalReviewItem
  canEdit: boolean
}) {
  return (
    <form action={canEdit ? updateTechnicalReviewAction : undefined}>
        ...
        <FieldGroup className="gap-6">
          ...
          >
            ...
            <div className="grid gap-4 md:grid-cols-2">
              ...
              <Field>
                <FieldLabel htmlFor="technical-grade">
                  Reviewed Grade
                </FieldLabel>
                <Input
                  autoComplete="off"
            ...
            <div className="flex flex-wrap gap-2">
              ...
              <Button asChild type="button" variant="outline">
                <Link href="/commercial/technical-review">
                  {canEdit ? "Cancel" : "Back To Technical Review"}
                </Link>
              </Button>
            </div>
          </div>
