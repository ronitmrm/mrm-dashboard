    ...
    >
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Showing {visibleRows.length} Of {candidates.length} Candidate
            Profiles
          </CardDescription>
        </CardHeader>
        ...
        <SheetContent className="w-full overflow-y-auto sm:max-w-xl">
          ...
          >
            ...
            <div className="grid flex-1 content-start gap-4 px-6">
              <Field>
                <FieldLabel htmlFor="candidate-log-event-type">
                  Conversation Type
                </FieldLabel>
                <NativeSelect
                  id="candidate-log-event-type"
                  name="event_type"
                  required
                >
                  {[
              ...
              <Field>
                <FieldLabel htmlFor="candidate-log-title">
                  Conversation Field
                </FieldLabel>
