...
function JobCardsPanel({
  ...
  return (
    <section className="grid gap-4">
      ...
      <section className="grid gap-4 @5xl/main:grid-cols-2">
        <DataRowsCard title="Job-card tiles" rows={asArray(productionControl.jobCardStatusTiles)} empty="No job-card status rows returned" />
...
function MachineDetailPanel({
  ...
  return (
    <>
      ...
      <DataRowsCard title="Machine planning board" rows={asArray(productionControl.machinePlanningRows)} empty="No machine planning board rows returned" />
