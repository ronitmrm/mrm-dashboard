...
function DashboardPageHeader({
  ...
  return (
    <section
      className={cn(
        "flex min-w-0 flex-wrap items-start justify-between gap-4 rounded-xl border border-primary/15 bg-[color-mix(in_srgb,var(--mrm-green)_5%,var(--color-surface))] p-4 shadow-[var(--shadow-sm)] sm:p-5",
        className
      )}
...
function FilterBar({
  ...
  return (
    <section
      aria-label={label}
      className={cn(
        "flex min-w-0 flex-wrap items-end gap-3 rounded-lg border bg-card p-3 shadow-[var(--shadow-sm)]",
        className
      )}
