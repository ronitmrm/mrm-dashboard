...
export const commercialNavigationAccess = [
  ...
  ["/commercial/sales", commercialCapabilities.sales.read],
  ["/commercial/technical-review", commercialCapabilities.technicalReview.read],
  ["/commercial/design", commercialCapabilities.design.read],
  ["/commercial/masters", commercialCapabilities.masters.read],
  ["/commercial/products", commercialCapabilities.masters.read],
  ["/commercial/assemblies", commercialCapabilities.masters.read],
  ["/commercial/drawing-history", commercialCapabilities.masters.read],
  ["/commercial/website-products", commercialCapabilities.masters.read],
  ["/commercial/costing", commercialCapabilities.costing.read],
  ["/commercial/quotes", commercialCapabilities.quotes.read],
  ["/commercial/pricing", commercialCapabilities.quotes.read],
