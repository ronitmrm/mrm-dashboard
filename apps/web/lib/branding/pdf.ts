  ...
  if (input.type === "notice") {
    ...
    return {
      ...
      *{box-sizing:border-box}body{margin:0;background:white;color:#050505}
      ...
      .notice-body h2{${typeStyle("section")}margin:0 0 .65em;text-align:center}
      article[lang=hi] .notice-body h2,article[lang=gu] .notice-body h2{${typeStyle("localHeading")}}
