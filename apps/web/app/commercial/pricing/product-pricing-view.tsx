...
export async function ProductPricingView({
  searchParams,
  showCustomerPricingLink,
}: {
  searchParams: Promise<{
    page?: string | string[]
  }>
  showCustomerPricingLink: boolean
}) {
          ...
          {showCustomerPricingLink ? (
            <CardAction>
              <Button asChild size="sm" variant="outline">
                <Link href="/commercial/pricing?view=customer">
                  Customer Pricing
                </Link>
              </Button>
            </CardAction>
                ...
                <Button asChild size="sm" variant="outline">
                  <Link
                    href={{
                      ...
                      query: { page: bounds.page - 1, view: "products" },
                    }}
                  >
                    Previous
                  </Link>
