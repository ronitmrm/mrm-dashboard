...
export default defineSchema({
  ...
  plannerPriorities: defineTable({
    ...
    priority: v.string(),
    approvalMode: v.optional(v.string()),
    interruptedJcNo: v.optional(v.string()),
    interruptedSetupNo: v.optional(v.string()),
    interruptedMachine: v.optional(v.string()),
    interruptedFinishedQty: v.optional(v.number()),
