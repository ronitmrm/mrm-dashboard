...
- Quality Control Tasks records downtime only: machine number, item/setup summary tile, downtime code selected from `downtime_reason_master`, 24-hour downtime start/end (`HH:mm`), and calculated downtime minutes.
