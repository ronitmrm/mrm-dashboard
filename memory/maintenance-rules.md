...
- 2026-07-13: Maintenance master uses generated MM### codes. Users create reusable maintenance schedule masters with title, frequency, optional checklistCode, estimated minutes, and status; Machine Master assigns those masters to machines.
