...
export function createRecruitmentEmploymentLetterRepository(
  ...
  async function listOffers(
    organizationId: string,
    scope: { column: "candidate_id" | "job_post_id"; id: string }
  ...
  return {
    ...
    listForCandidate(organizationId: string, candidateId: string) {
      return listOffers(organizationId, {
        column: "candidate_id",
        id: candidateId,
      })
    },

    listForJob(organizationId: string, jobId: string) {
      return listOffers(organizationId, { column: "job_post_id", id: jobId })
    },
