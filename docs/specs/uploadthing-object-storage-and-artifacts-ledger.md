...
- The [UploadThing pricing page](https://uploadthing.com/pricing), reviewed on 2026-08-22, advertises 2 GB shared storage and unlimited uploads/downloads for the free app tier. The application ledger therefore reports unique live bytes against 2 GB, but it does not enforce provider billing or plan changes.
