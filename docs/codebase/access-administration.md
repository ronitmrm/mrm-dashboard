...
every authenticated user. They do not require Document Templates role grants. Register PDF
routes serve only the latest issued revision. Document Templates authoring, drafts, and
...
| PPAC Conventional-01  | Existing PPAC tabs                                                                                                          | 11 Pages / 18 Tasks | Floor pages and production commands                                                    | View plus each exact production command                                                 | dashboard floor tabs                                   | `app/api/[...path]/route.ts` and dashboard events                 | floor-scoped operations keys plus migrated server gates             | floor page/task catalogues                                            | Covered |
| PPAC Conventional-02  | Existing PPAC tabs                                                                                                          | 11 Pages / 18 Tasks | Floor pages and production commands                                                    | View plus each exact production command                                                 | dashboard floor tabs                                   | `app/api/[...path]/route.ts` and dashboard events                 | floor-scoped operations keys plus migrated server gates             | floor page/task catalogues                                            | Covered |
| PPAC CNC-01           | Existing PPAC tabs                                                                                                          | 11 Pages / 18 Tasks | Floor pages and production commands                                                    | View plus each exact production command                                                 | dashboard floor tabs                                   | `app/api/[...path]/route.ts` and dashboard events                 | floor-scoped operations keys plus migrated server gates             | floor page/task catalogues                                            | Covered |
| PPAC Forging          | Existing PPAC tabs                                                                                                          | 11 Pages / 18 Tasks | Floor pages and production commands                                                    | View plus each exact production command                                                 | dashboard floor tabs                                   | `app/api/[...path]/route.ts` and dashboard events                 | floor-scoped operations keys plus migrated server gates             | floor page/task catalogues                                            | Covered |
