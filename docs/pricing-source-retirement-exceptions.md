...
| Formula audit proposes a future derived-product cost boundary                                               | Deferred functional change            | Retain the executable source rule that stores machining price per piece. Any formula change requires a separate approved change.                  |
